...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_404_request_question_beyond_valid_page(self):
    ...
    def test_delete_question(self):
        ''' create new question for deletion '''
        ...
        question_query = Question.query.filter( Question.id == question.id).one_or_none()
    ...
    def test_422_add_question_fail(self):
    ...
    def test_400_get_questions_per_category(self):
