...
## Authors
Yours truly, Earl Potters
 
## Acknowledgements 

All other project files, other than the __init__.py, test_flaskr.py and README.md, were created by [Udacity](https://www.udacity.com/) as a project template for the [Full Stack Web Developer Nanodegree](https://www.udacity.com/course/full-stack-web-developer-nanodegree--nd0044).